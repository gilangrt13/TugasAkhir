...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="index.php">Tugas Akhir</a>
            ...
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control w-50" id="nis" placeholder="Masukkan NPM" min="1" name="nim" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
